...
class CompaniesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.companies.index')->with('success', 'Η εταιρεία αποθηκεύτηκε');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $company->save();
        $company->categories()->sync($request->input('categories', []));
        return redirect()->route('admin.companies.index')->with('success', 'Η εταιρεία ενημερώθηκε');
    }
    ...
    public function destroy($id)
    {
        $company = Company::find($id);
        $company->delete();
        return redirect()->route('admin.companies.index')->with('success', 'Η εταιρεία διαφράφηκε');
    }
}
