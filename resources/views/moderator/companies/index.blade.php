...
<div class="container-fluid">
    <div class="row">
      <div class="col-12">         
            <a class="btn btn-success" href="{{ route('moderator.companies.create') }}" >
               Προσθήκη εταιρείας  
            </a><br><br>
                    ...
                    <tbody>
                        @foreach($companies as $company)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('moderator.companies.edit', $company->id) }}">
                                    ...
                                    <div class="collapse">
                                            <form id="delete-form-{{ $company->id }}" action="{{ route('moderator.companies.destroy',$company->id) }}" method="POST" style="display:none;">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                                            </form>
                                    </div>
